...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/dspic33_dsc_sk1_selftest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../runner/runner.c ../dspic33_dsc_sk1/WM8510CodecDrv.c ../dspic33_dsc_sk1/sk1_Initialization.c ../effects.c ../foundation.c ../dspic33_dsc_sk1/sk1_selftest_main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/835468705/runner.o ${OBJECTDIR}/_ext/354150267/WM8510CodecDrv.o ${OBJECTDIR}/_ext/354150267/sk1_Initialization.o ${OBJECTDIR}/_ext/1472/effects.o ${OBJECTDIR}/_ext/1472/foundation.o ${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/835468705/runner.o.d ${OBJECTDIR}/_ext/354150267/WM8510CodecDrv.o.d ${OBJECTDIR}/_ext/354150267/sk1_Initialization.o.d ${OBJECTDIR}/_ext/1472/effects.o.d ${OBJECTDIR}/_ext/1472/foundation.o.d ${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/835468705/runner.o ${OBJECTDIR}/_ext/354150267/WM8510CodecDrv.o ${OBJECTDIR}/_ext/354150267/sk1_Initialization.o ${OBJECTDIR}/_ext/1472/effects.o ${OBJECTDIR}/_ext/1472/foundation.o ${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o

# Source Files
SOURCEFILES=../runner/runner.c ../dspic33_dsc_sk1/WM8510CodecDrv.c ../dspic33_dsc_sk1/sk1_Initialization.c ../effects.c ../foundation.c ../dspic33_dsc_sk1/sk1_selftest_main.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/dspic33_dsc_sk1_selftest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o: ../dspic33_dsc_sk1/sk1_selftest_main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/354150267 
	@${RM} ${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o.d 
	@${RM} ${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o.ok ${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o.err 
	@${RM} ${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -omf=coff -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -ffunction-sections -Wall -msmall-code -mlarge-data -mconst-in-code -MMD -MF "${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o.d" -o ${OBJECTDIR}/_ext/354150267/sk1_selftest_main.o ../dspic33_dsc_sk1/sk1_selftest_main.c    -fast-math -legacy-libc
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/dspic33_dsc_sk1_selftest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../Program\ Files/Microchip/MPLAB\ C30/lib/libq-coff.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=coff -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/dspic33_dsc_sk1_selftest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}   "..\..\..\Program Files\Microchip\MPLAB C30\lib\libq-coff.a"     -fast-math -legacy-libc -Wl,--defsym=__MPLAB_BUILD=1,--stack=16,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PICKIT2=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/dspic33_dsc_sk1_selftest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../Program\ Files/Microchip/MPLAB\ C30/lib/libq-coff.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=coff -mcpu=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/dspic33_dsc_sk1_selftest.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}   "..\..\..\Program Files\Microchip\MPLAB C30\lib\libq-coff.a"     -fast-math -legacy-libc -Wl,--defsym=__MPLAB_BUILD=1,--stack=16,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
	${MP_CC_DIR}\\pic30-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/dspic33_dsc_sk1_selftest.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -omf=coff
endif
