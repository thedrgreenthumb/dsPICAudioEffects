...
%  _________________
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
classdef fanalizer < handle
%FANALIZER - class for investigation, implemetation and testing DSP algorithms and filters.
%
%Public methods list:
%
%   fanalizer(sampleRate);
%   sr = getSampleRate();
%   setSampleRate(sr);
%   
...
%   spectrogram3D(data);
    ...
    methods
        function obj = fanalizer(sampleRate)
